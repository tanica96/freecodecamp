...
module.exports.search = function search(term) {
  var url = "https://downloads.codingcoursestv.eu/041%20-%20javascript/proxy/search.php";
...
module.exports.info = function info(fdcId) {
  var url = "https://downloads.codingcoursestv.eu/041%20-%20javascript/proxy/product.php";
  return axios.get(url, {
    params: {
      q: fdcId
    }
...
/***/ "./src/controllers/ProductList.js":
/*!****************************************!*\
  !*** ./src/controllers/ProductList.js ***!
  \****************************************/
/*! no static exports found */
...
var _require2 = __webpack_require__(/*! ../utils/dom */ "./src/utils/dom.js"),
    on = _require2.on;

var addProductTemplate = __webpack_require__(/*! ../templates/ProductList/addProduct.ejs */ "./src/templates/ProductList/addProduct.ejs");
...
ProductList.prototype.init = function () {
  ...
  on(".product-search__remove-product", "click", function (event) {
    var fdcId = parseInt(event.handleObj.getAttribute("data-fdc"), 10);

    _this.removeProduct(fdcId);
  });
  on(".product-search__amount", "change", function (event) {
    var fdcId = parseInt(event.handleObj.getAttribute("data-fdc"), 10);
    var value = parseInt(event.handleObj.value, 10);

    _this.updateAmount(fdcId, value);
  });
};

ProductList.prototype.emitNutrients = function () {
  var nutrients = this.getNutrients();
...
ProductList.prototype.getNutrientsForProduct = function (product) {
  ...
  var _iterator = _createForOfIteratorHelper(product.product.foodNutrients),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var foodNutrient = _step.value;
...
ProductList.prototype.getNutrients = function () {
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      var productNutrients = this.getNutrientsForProduct(product);
...
ProductList.prototype.updateAmount = function (fdcId, value) {
  ...
  this.emitNutrients(); // console.log("updateAmount:", this.products)
};
...
ProductList.prototype.removeProduct = function (fdcId) {
  ...
  if (index !== null) {
    ...
    var trElement = document.querySelector(".product-search__product-row[data-fdc='" + fdcId + "']");
    if (trElement) trElement.remove();
  }

  this.emitNutrients(); // console.log("this.products:", this.products)
};
...
ProductList.prototype.addProduct = function (fdcId) {
  ...
  info(fdcId).then(function (product) {
    _this2.products.push({
      amount: 100,
      product: product
    });

    console.log("this.products:", _this2.products);
    var productHtml = addProductTemplate({
      title: product['description'],
      fdcId: product['fdcId']
    }); // this.listElement.innerHTML = this.listElement.innerHTML + productHtml

    _this2.listElement.insertAdjacentHTML("beforeend", productHtml); // console.log(productHtml)
    // this.getNutrients()


    _this2.emitNutrients();
  });
};
...
/***/ "./src/controllers/ProductNutrients.js":
/*!*********************************************!*\
  !*** ./src/controllers/ProductNutrients.js ***!
  \*********************************************/
/*! no static exports found */
...
ProductSearch.prototype.init = function () {
  ...
  this.buttonElement.addEventListener("click", function (event) {
    ...
    _this.runSearch(inputValue);
  });
  on(".product-search--result-item", "click", function (event) {
    event.originalEvent.preventDefault();
    var fdcId = event.handleObj.getAttribute("data-fdcid");

    _this.events.emit("productSelected", fdcId);
  });
};
/**
 * @param {String} term
...
ProductSearch.prototype.runSearch = function (term) {
  ...
  search(term).then(function (results) {
    _this2.resultElement.innerHTML = "";
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        _this2.resultElement.append(linkElement);
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
...
var ProductSearch = __webpack_require__(/*! ./controllers/ProductSearch */ "./src/controllers/ProductSearch.js");

var ProductList = __webpack_require__(/*! ./controllers/ProductList */ "./src/controllers/ProductList.js");

var ProductNutrients = __webpack_require__(/*! ./controllers/ProductNutrients */ "./src/controllers/ProductNutrients.js");

var productSearch = new ProductSearch(document.getElementById("productSearchInput"), document.getElementById("productSearchButton"), document.getElementById("productSearchResults"));
productSearch.init();
var productList = new ProductList(document.getElementById("productList"));
productList.init();
productList.addProduct(362759);
var productNutrients = new ProductNutrients(document.getElementById("productNutrient--carbs"), document.getElementById("productNutrient--protein"), document.getElementById("productNutrient--fat"));
productNutrients.init();
productSearch.events.on("productSelected", function (fdcId) {
  productList.addProduct(fdcId);
});
productList.events.on("nutrientChange", function (nutrients) {
  productNutrients.setNutrients(nutrients);
});

/***/ }),

/***/ "./src/templates/ProductList/addProduct.ejs":
/*!**************************************************!*\
  !*** ./src/templates/ProductList/addProduct.ejs ***!
  \**************************************************/
/*! no static exports found */
...
var __t, __p = '';
with (obj) {
__p += '<tr class="product-search__product-row" data-fdc="' +
((__t = ( fdcId )) == null ? '' : __t) +
'">\n  <td>\n    <span>' +
((__t = ( title )) == null ? '' : __t) +
'</span>\n  </td>\n  <td>\n    <input class="product-amount product-search__amount" type="number" value="100" min="0" data-fdc="' +
((__t = ( fdcId )) == null ? '' : __t) +
